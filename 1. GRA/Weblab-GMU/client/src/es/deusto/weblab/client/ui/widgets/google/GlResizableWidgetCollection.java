 ...
 * {@link GlResizableWidgetCollection} uses a timer, so consider the cost when
 * adding one.
 *
 * Typically, a {@link GlResizableWidgetCollection} is only needed if you expect
...
public class GlResizableWidgetCollection implements ResizeHandler,
  ...
  static class ResizableWidgetInfo {
    ...
    private GlResizableWidget widget;
     ...
     */
    public ResizableWidgetInfo(GlResizableWidget widget) {
      this.widget = widget;
      updateSizes();
    }
  ...
  /**
   * A static {@link GlResizableWidgetCollection} that can be used in most cases.
   */
  private static GlResizableWidgetCollection staticCollection = null;

  /**
   * Get the globally accessible {@link GlResizableWidgetCollection}. In most
   * cases, the global collection can be used for all {@link GlResizableWidget}s.
   *
   * @return the global {@link GlResizableWidgetCollection}
   */
  public static GlResizableWidgetCollection get() {
    if (staticCollection == null) {
      staticCollection = new GlResizableWidgetCollection();
    }
   ...
   */
  private Map<GlResizableWidget, ResizableWidgetInfo> widgets = new HashMap<GlResizableWidget, ResizableWidgetInfo>();
  ...
  /**
   * Create a GlResizableWidget.
   */
  public GlResizableWidgetCollection() {
   ...
   */
  public GlResizableWidgetCollection(boolean resizeCheckingEnabled) {
   ...
   */
  public GlResizableWidgetCollection(int resizeCheckDelay) {
   ...
   * Constructor.
   */
  protected GlResizableWidgetCollection(int resizeCheckDelay,
   ...
   */
  public void add(GlResizableWidget widget) {
  ...
  public void checkWidgetSize() {
    for (Map.Entry<GlResizableWidget, ResizableWidgetInfo> entry : widgets.entrySet()) {
      GlResizableWidget widget = entry.getKey();
  ...
  @Override
public Iterator<GlResizableWidget> iterator() {
   ...
   */
  public void remove(GlResizableWidget widget) {
  ...
  /**
   * Inform the {@link GlResizableWidgetCollection} that the size of a widget has
   ...
   */
  public void updateWidgetSize(GlResizableWidget widget) {
